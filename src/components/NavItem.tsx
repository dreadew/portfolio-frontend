									...
									<div className="col-span-4 col-start-1 grid grid-cols-3 gap-x-8">
										{
											category.featured.map((item) => (
												...
												className="group relative text-base sm:text-sm">
													...
													<Link href={item.href} className="mt-6 block font-medium text-md text-gray-900">{item.name}</Link>
													<p className="mt-0-5 text-xs text-muted-foreground" aria-hidden="true">Shop now</p>
												</div>
											))
										}
									</div>
